package com.hunga.simpleemc.compat.jade;

import com.hunga.simpleemc.EMCRegistry;
import com.hunga.simpleemc.AlchemicalHourglassBlock;
    ...
    public void registerClient(IWailaClientRegistration registration) {
        ...
        registration.registerBlockComponent(new IBlockComponentProvider() {
            ...
            public ResourceLocation getUid() {
                return ResourceLocation.fromNamespaceAndPath("simpleemc", "emc");
            }
        }, Block.class);
        ...
        registration.registerBlockComponent(new IBlockComponentProvider() {
            ...
            @Override
            public ResourceLocation getUid() {
                return ResourceLocation.fromNamespaceAndPath("simpleemc", "hourglass");
            }
