...
To compile the mod yourself, make sure you have Java 17 (or Java 23 with Gradle 8.10+) installed, then run the following command in the project root:
...
`../mods/simpleemc-1.20.1-forge-1.0.1.jar`
